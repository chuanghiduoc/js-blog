! function(t) {
    ...
    e.prototype = {
        ...
        show: function() {
            ...
            if (this.hasContent() && this.enabled) {
                ...
                t.offset(l).addClass(s).addClass("in")
            }
        },
        setContent: function() {
            var t = this.tip(),
    ...
    var t = document.body.classList.toggle("night");
    localStorage.setItem("darkmode-banner", t)
}), jQuery(document).ready(function(t) {
    t(function() {
        t("darkmode").click(function(t) {
            t.preventDefault()
        })
    })
}), document.getElementById("gridmode").addEventListener("click", function() {
    var t = document.body.classList.toggle("list");
    localStorage.setItem("gridmode-banner", t)
}), jQuery(document).ready(function(t) {
    t(function() {
        t("gridmode").click(function(t) {
            t.preventDefault()
        })
    })
}), console.log("%cDeveloped by Bảo Trọng 😎\n=> https://fb.com/chuanghiduoc9\nMua template liên hệ mình nhé!", "font:2.5em Roboto;color:#ff0000");
